...
async def execute(code):  
  prefix = "var window={\"parseInt\": parseInt, \"Math\": Math, \"WebSocket\": 1, \"location\": {\"host\": \"iyiyiyiyi\"}, \"navigator\": { \"userAgent\": \"Mozilla/5.0 (X11; Linux x86_64; rv:10.0) Gecko/20150101 Firefox/20.0 (Chrome)\"}}"
  if dukpy_available:
